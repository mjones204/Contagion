...
function Slideshow(){
	...
	self.goto = function(index, forceClear){
		...
		if (index > 10 && !Simulations.awaitingResponse){
			console.log("getting config via slideshow");
			self.IS_TRANSITIONING = false;
		...
		_setTimeout(function(){
			...
			if (index > 10){
				document.getElementById("simulations").style.height="100%";
				document.getElementById("simulations").style.width="100%";
			}
